"""CLI entry point for scRNA + scATAC analysis."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the scRNA + scATAC analysis agent.")
    parser.add_argument("--rna-h5ad-path", required=True, help="Path to the RNA .h5ad file.")
    parser.add_argument("--atac-h5ad-path", required=True, help="Path to the ATAC .h5ad file.")
    ...
    parser.add_argument("--analysis-name", default="scrat_run", help="Name for the analysis run.")
    ...
    parser.add_argument("--vision-model", default=os.environ.get("SCRAT_VISION_MODEL", "gpt-4o"), help="Vision model used when enabled.")
    ...
    agent = ScRATAgent(
        ...
        atac_h5ad_path=args.atac_h5ad_path,
