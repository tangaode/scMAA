"""CLI entry point for scRNA + spatial analysis."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the scRNA + spatial analysis agent.")
    parser.add_argument("--rna-h5ad-path", required=True, help="Path to the RNA .h5ad file.")
    parser.add_argument("--spatial-h5ad-path", required=True, help="Path to the spatial .h5ad file.")
    parser.add_argument("--research-brief-path", required=True, help="Path to a freeform research brief text file.")
    parser.add_argument("--literature-path", action="append", default=[], help="Optional literature file or folder.")
    parser.add_argument("--analysis-name", default="scrst_run", help="Name for the analysis run.")
    ...
    parser.add_argument("--vision-model", default=os.environ.get("SCRST_VISION_MODEL", "gpt-4o"), help="Vision model used when enabled.")
    ...
    parser.add_argument(
        ...
        choices=["auto", "marker_transfer", "cell2location"],
        default="auto",
        help="How to map scRNA-defined states onto spatial data.",
    )
    ...
    parser.add_argument("--figure-name", default=None, help="Optional base name for figure outputs.")
    ...
    parser.add_argument("--seed-hypothesis", action="append", default=[], help="Optional seeded hypothesis.")
    args = parser.parse_args()

    agent = ScRSTAgent(
        rna_h5ad_path=args.rna_h5ad_path,
        spatial_h5ad_path=args.spatial_h5ad_path,
        ...
        spatial_mapping_method=args.spatial_mapping_method,
